  ...
  module WAS
    ...
    class Importer < Dradis::Plugins::Upload::Importer
      ...
      def process_evidence(xml_vulnerability)
        ...
        evidence_content = mapping_service.apply_mapping(source: 'was-evidence', data: xml_vulnerability)
      ...
      def process_issue(xml_qid)
        ...
        issue_text = mapping_service.apply_mapping(source: 'was-issue', data: xml_qid)
